...
{
	public interface IChenyuanDBContext
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// <param name="parameters"></param>
		/// <returns></returns>
		DataTable ExecuteSql(string sql, int? timeout = null, params object[] parameters);
		...
		/// <param name="parameters">The parameters to apply to the command string.</param>
		/// <returns>The result returned by the database after executing the command.</returns>
		IList<TEntity> ExecuteSqlCommandForBaseEntity<TEntity>(string sql, int? timeout = null, params object[] parameters) where TEntity : BaseEntity, new();
