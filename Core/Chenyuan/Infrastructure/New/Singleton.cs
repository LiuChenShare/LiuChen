...
namespace Chenyuan.Infrastructure
{
	...
	public class Singleton<T> : Singleton
	{
		...
		/// 
		/// </summary>
		public static T ChannelInstance
		{
	...
	public class SingletonList<T> : Singleton<IList<T>>
	{
		static SingletonList()
		{
			...
			Singleton<IList<T>>.ChannelInstance = new List<T>();
		}
		...
		/// 
		/// </summary>
		public new static IList<T> ChannelInstance
		{
			get { return Singleton<IList<T>>.ChannelInstance; }
		}
	}
	...
	public class SingletonDictionary<TKey, TValue> : Singleton<IDictionary<TKey, TValue>>
	{
		static SingletonDictionary()
		{
			...
			Singleton<Dictionary<TKey, TValue>>.ChannelInstance = new Dictionary<TKey, TValue>();
		}
		...
		/// 
		/// </summary>
		public new static IDictionary<TKey, TValue> ChannelInstance
		{
			get { return Singleton<Dictionary<TKey, TValue>>.ChannelInstance; }
		}
	}
