...
namespace Chenyuan.Data.Base
{
    public class BaseDataContext : DataContext
    {
        ...
        //连接字符串。
        public BaseDataContext(IDatabase database) : base(database)
        {
        }

        public BaseDataContext(string nameOrConnectionString, string mappingAssembly) : base(nameOrConnectionString, mappingAssembly)
        {
        }
